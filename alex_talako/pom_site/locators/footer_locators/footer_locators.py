...
class MainPage(WebPage):
    ...
    btn_privacy_policy = WebElement(xpath='//a[@href="/legal/privacy-policy"]')
    btn_terms_of_use = WebElement(xpath='//a[@href="/legal/terms-of-use"]')
    btn_ai_terms_of_use = WebElement(xpath='//a[@href="/legal/ai-terms-of-use"]')
    btn_acceptable_use_policy = WebElement(xpath='//a[@href="/legal/acceptable-use-policy"]')
    btn_cookie_policy = WebElement(xpath='//a[@href="/legal/cookie-policy"]')
    btn_contact_us = WebElement(xpath = '//a[@href="/contact"]')
    btn_affiliates = WebElement(xpath = '//a[@href="/affiliates"]')
    btn_forum = WebElement(xpath='//a[@href="/forum"]')
    btn_students_discount = WebElement(xpath = '//a[@href="https://www.studentbeans.com/en-gb/uk/beansid-connect/hosted/tryhackme"]')
    btn_swag_shop = WebElement(xpath = '//a[@href="https://store.tryhackme.com"]')
